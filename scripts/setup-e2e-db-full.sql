-- E2E Test Database Setup - Full Schema
-- Creates complete schema including auth tables and test data
...
-- Password hash for 'admin' using simple hash (matches authStore.tsx logic)
INSERT OR IGNORE INTO users (id, email, password_hash, name, role, plan, status)
VALUES (1, 'admin@rsa.local', '1jpfvj', 'Administrator', 'admin', 'nhra', 'active');
