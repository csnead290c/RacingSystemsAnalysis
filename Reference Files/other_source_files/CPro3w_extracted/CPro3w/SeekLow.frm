VERSION 5.00
Begin VB.Form frmSeekLow 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   " Select: Low Gear Lockup RPM"
   ClientHeight    =   1095
   ClientLeft      =   8115
   ClientTop       =   7005
   ClientWidth     =   2970
...
100 gc_CWt1.Value = CWT
    ...
    ClutchCalc
    ER = gc_SeekLoRPM.Value - val(frmClutch.Label4.caption)
