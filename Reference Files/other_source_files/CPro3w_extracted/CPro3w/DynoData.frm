...
Private Sub Form_Resize()
    If gphEngine.Width <> Me.ScaleWidth Or gphEngine.Height <> Me.ScaleHeight Then
        ReSizeGraph
    End If
End Sub
...
Dim ysave As Integer
    ...
    With gphEngine
        ...
        .XAxisMin = RoundDown(gc_grdDyno.GridArray(0, 0), 500)
        .XAxisMax = 0
        .YAxisMin = 9999
        .YAxisMax = 0
        ...
        For i = 0 To gc_grdDyno.MaxRow - 1
            ...
            If gc_grdDyno.GridArray(0, i) > .XAxisMax Then
                .XAxisMax = gc_grdDyno.GridArray(0, i)
            End If
            
            If gc_grdDyno.GridArray(1, i) < .YAxisMin Then
                .YAxisMin = gc_grdDyno.GridArray(1, i)
            End If
            
            If gc_grdDyno.GridArray(1, i) > .YAxisMax Then
                .YAxisMax = gc_grdDyno.GridArray(1, i)
            End If
        Next
        ...
        For i = 0 To .NumPoints - 1
            If gc_grdDyno.GridArray(2, i) < .YAxisMin Then
                .YAxisMin = gc_grdDyno.GridArray(2, i)
            End If
            
            If gc_grdDyno.GridArray(2, i) > .YAxisMax Then
                .YAxisMax = gc_grdDyno.GridArray(2, i)
            End If
        Next
        ...
        For i = 1 To .NumPoints
            .ThisPoint = i
            .GraphData = gc_grdDyno.GridArray(1, i - 1)
            .OverlayGraphData = gc_grdDyno.GridArray(2, i - 1)
            .XPosData = gc_grdDyno.GridArray(0, i - 1)
            .OverlayXPosData = gc_grdDyno.GridArray(0, i - 1)
        Next
